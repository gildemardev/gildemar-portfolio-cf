...
const home: FC<homeProps> = () => {
	return (
		<>
			<main className='flex flex-col items-center justify-center h-screen max-h-screen bg-black text-white'>
				<Navbar />
				...
				<div className='space-y-4 pt-10 px-2 sm:px-4 '>
					<span className='inline-flex flex-nowrap px-5 py-2 border-2 border-zinc-800 rounded-full text-zinc-300 text-sm font-semibold bg-gradient-to-r from-zinc-900 via-zinc-800 to-zinc-800'>
						<FaRegHandPeace className='size-5 mr-2 text-zinc-300' />E aí, tudo
						bem?
					</span>
					<h1 className='scroll-m-20 text-3xl sm:text-4xl font-semibold tracking-tight lg:text-6xl md:w-2/3'>
						Profissional multidisciplinar. Sou Designer, Motion Designer &
						Programador.
					</h1>
					<a
